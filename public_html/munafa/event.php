...
$conn =  mysqli_connect('localhost','punese3g_biec', 'PSF@BIEC69');
mysqli_select_db($conn,'punese3g_event');
// Check connection
if (!$conn) {
...
<body style="background-color: #0c0624;">
  ...
  <div class="logo" style="top: 1%;right: 1%;"><a href="./main"><img src="./images/navbarAndFooter/MM + PSF + BF.png"
        alt=""></a>
  </div>
  </div>
